          ...
          <div className="flex flex-col gap-16">
            <div className="flex flex-col gap-2 text-center">
              ...
              <p className="text-base font-medium leading-7 text-dark-grey-600">
                We help you create a customise itinerary based on your
                requirement and give you package to directly book it.
              </p>
            </div>
          </div>
          <div className="flex w-full flex-col items-center justify-between gap-y-10 lg:flex-row lg:gap-x-8 lg:gap-y-0 xl:gap-x-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-base font-medium leading-7 text-dark-grey-600">
                  We will apply our travel brain and create a personalised
                  curated itinerary for you.
                </p>
              </div>
            </div>
            <div className="rotate-90 lg:rotate-0">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-base font-medium leading-7 text-dark-grey-600">
                  ...
                  book. Once booked you are ready for an awesome travel
                  experience
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-16">
            <div className="flex flex-col gap-2 text-center">
              ...
              <p className="text-base font-medium lg:text-xl sm:text-sm leading-7 text-dark-grey-600">
                ...
                travel type. We add offbeat places which are not usually visited
                by people. And to add we give exclusive travel deals in our
                packages
              </p>
            </div>
          </div>
