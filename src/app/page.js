...
export default function Home() {
  return (
    <div className="w-screen">
      <div className="mt-20 w-screen bg-fixed bg-cover bg-center relative  bg-[url('/common/hero1.gif')] lg:bg-[url('/common/hero1.gif')] md:lg:bg-[url('/common/hero1.gif')] sm:bg-[url('/common/gifgit.gif')] h-96">
